...
- Implemented the first Event Companion vector extraction slice: deterministic board transform, deployment-zone extraction, terrain footprint extraction from gray vector drawings, terrain-label proximity, perimeter LOS proxy blockers, and validation records noting pending internal wall enrichment. Synthetic vector-PDF and cached official page 9 tests pass.
